...
compact_profile_fixture <- function(x, n = rows_per_group, additional_groups = character()) {
...
compact_biosample_summary_fixture <- function(x, n = rows_per_group) {
  attr(x, 'biosample_anatomy_profile') <- compact_profile_fixture(attr(x, 'biosample_anatomy_profile', exact = TRUE), n = n)
  attr(x, 'biosample_canonical_profile') <- compact_profile_fixture(attr(x, 'biosample_canonical_profile', exact = TRUE), n = n)
...
compact_biosample_skew_fixture <- function(x, n = rows_per_group) {
  attr(x, 'biosample_anatomy_profile') <- attr(x, 'biosample_anatomy_profile', exact = TRUE) |>
    dplyr::mutate(.has_bioproject = !is.na(.data$bioproject) & nzchar(trimws(as.character(.data$bioproject)))) |>
    compact_profile_fixture(n = n, additional_groups = '.has_bioproject') |>
    dplyr::select(-dplyr::all_of('.has_bioproject'))
  x
}

compact_interaction_fixture <- function(x, n = rows_per_group) {
  attr(x, 'interaction_profile') <- compact_profile_fixture(attr(x, 'interaction_profile', exact = TRUE), n = n)
  x
}
...
compact_biosample_extract_fixture <- function(x, n = rows_per_group) {
  structure(
    x |>
      ...
      dplyr::slice_head(n = n) |>
      dplyr::ungroup(),
    query_info = attr(x, 'query_info', exact = TRUE),
    gama_object = attr(x, 'gama_object', exact = TRUE),
    class = class(x)
  )
}
...
SRA_SKEW_BP_Arabidopsis_thaliana <- summarise_sra_skew(SRA_SUMMARY_Arabidopsis_thaliana, unit = 'bioproject')
SRA_SKEW_BS_Arabidopsis_thaliana <- summarise_sra_skew(SRA_SUMMARY_Arabidopsis_thaliana, unit = 'biosample')
...
INTERACTION_CLASS_Arabidopsis_thaliana <- compact_interaction_fixture(INTERACTION_CLASS_Arabidopsis_thaliana, n = rows_per_group)
INTERACTION_SUBCLASS_Arabidopsis_thaliana <- compact_interaction_fixture(INTERACTION_SUBCLASS_Arabidopsis_thaliana, n = rows_per_group)

SRA_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(SRA_SUMMARY_Arabidopsis_thaliana)
SRA_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(SRA_SUMMARY_Arabidopsis_thaliana, view = 'records')

SRA_SKEW_BP_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(SRA_SKEW_BP_Arabidopsis_thaliana)
SRA_SKEW_BP_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(SRA_SKEW_BP_Arabidopsis_thaliana, view = 'records')

SRA_SKEW_BS_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(SRA_SKEW_BS_Arabidopsis_thaliana)
SRA_SKEW_BS_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(SRA_SKEW_BS_Arabidopsis_thaliana, view = 'records')

BIO_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(BIO_SUMMARY_Arabidopsis_thaliana)
BIO_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(BIO_SUMMARY_Arabidopsis_thaliana, view = 'records')

BIO_SKEW_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(BIO_SKEW_Arabidopsis_thaliana)
BIO_SKEW_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(BIO_SKEW_Arabidopsis_thaliana, view = 'records')

INTERACTION_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana <- report_diagnostics(INTERACTION_CLASS_Arabidopsis_thaliana)
INTERACTION_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana <- report_diagnostics(INTERACTION_CLASS_Arabidopsis_thaliana, view = 'records')
...
save_fixture(SRA_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'SRA_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(SRA_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'SRA_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BP_Arabidopsis_thaliana, 'SRA_SKEW_BP_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BP_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'SRA_SKEW_BP_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BP_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'SRA_SKEW_BP_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BS_Arabidopsis_thaliana, 'SRA_SKEW_BS_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BS_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'SRA_SKEW_BS_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(SRA_SKEW_BS_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'SRA_SKEW_BS_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
...
save_fixture(BIO_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'BIO_SUMMARY_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(BIO_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'BIO_SUMMARY_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
save_fixture(BIO_SKEW_Arabidopsis_thaliana, 'BIO_SKEW_Arabidopsis_thaliana')
save_fixture(BIO_SKEW_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'BIO_SKEW_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(BIO_SKEW_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'BIO_SKEW_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
...
save_fixture(INTERACTION_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana, 'INTERACTION_DIAGNOSTICS_RECOVERABILITY_Arabidopsis_thaliana')
save_fixture(INTERACTION_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana, 'INTERACTION_DIAGNOSTICS_RECORDS_Arabidopsis_thaliana')
