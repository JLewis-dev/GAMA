...
SKEW_BIOPROJECT_Arabidopsis_thaliana <- summarise_sra_skew(SRA_SUMMARY_Arabidopsis_thaliana, unit = 'bioproject')
SKEW_BIOSAMPLE_Arabidopsis_thaliana <- summarise_sra_skew(SRA_SUMMARY_Arabidopsis_thaliana, unit = 'biosample')
...
save_fixture(SKEW_BIOPROJECT_Arabidopsis_thaliana, 'SKEW_BIOPROJECT_Arabidopsis_thaliana')
save_fixture(SKEW_BIOSAMPLE_Arabidopsis_thaliana, 'SKEW_BIOSAMPLE_Arabidopsis_thaliana')
